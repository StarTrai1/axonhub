...
const (
	...
	// UserAgent is the offline fallback identity for Claude Code requests.
	claudeCodeDefaultVersion = "2.1.231"
	UserAgent                = "claude-cli/" + claudeCodeDefaultVersion + " (external, cli)"
