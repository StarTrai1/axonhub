...
func RequestFromLLM(ctx context.Context, r *llm.Request, reasoningField ReasoningField) *Request {
	...
	if req.ToolChoice != nil && req.ToolChoice.NamedToolChoice != nil && req.ToolChoice.NamedToolChoice.Type == llm.ToolTypeFunction {
		req.ToolChoice.NamedToolChoice.Function.Name = chatNamedToolChoiceName(r)
	}
