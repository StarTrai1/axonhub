...
func TestChannelService_BulkUpdateChannelAutoDisable_WriteRulesKeepsStream(t *testing.T) {
	...
	require.Equal(t, objects.RoutingTierPreferred, got1.Policies.RoutingTier)
	require.Equal(t, objects.RemoteCompactionPolicyLocalBridge, got1.Policies.RemoteCompaction)
	require.Equal(t, objects.WebSearchPolicyMCPOnly, got1.Policies.WebSearch)
	require.Equal(t, objects.CodexIdentityPolicySession, got1.Policies.CodexIdentity)
	require.Equal(t, []string{"09:30:00"}, got1.Policies.ScheduledHealthChecks)
