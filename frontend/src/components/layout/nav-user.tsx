...
import { BadgeCheck, ChevronsUpDown, LogOut, SlidersHorizontal } from 'lucide-react';
...
import { MenuCustomizeDialog } from '@/components/layout/menu-customize-dialog';
          ...
          <DropdownMenu>
            ...
            >
              ...
              <DropdownMenuGroup>
                ...
                <DropdownMenuItem onSelect={() => setTimeout(() => setCustomizeOpen(true), 0)}>
                  <SlidersHorizontal />
                  {t('sidebar.userMenu.customizeMenu')}
                </DropdownMenuItem>
              </DropdownMenuGroup>
              <DropdownMenuSeparator />
