...
import { APIKeyAutoDisableMode, Channel, channelPoliciesSchema } from '../data/schema';
...
export function ChannelsAvailabilityDialog({ open, onOpenChange, currentRow }: Props) {
  ...
  const onSubmit = useCallback(async () => {
    ...
    try {
      await updateChannel.mutateAsync({
        id: currentRow.id,
        input: {
          policies: channelPoliciesSchema.parse({
            ...currentPolicies,
  ...
  }, [currentPolicies, currentRow.id, mode, onOpenChange, rules, t, updateChannel]);
